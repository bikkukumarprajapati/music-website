...
<body>
    <header>
        <div class="menu_side" id="abc">
            <h6 id="menu_list_active_button"><i class="bi bi-music-note-list"></i></h6>
            <h1>Playlist</h1>
            <div class="playlist">
                <h4 class="active"><span></span><i class=" bi active1 bi-music-note-beamed"><spna class="abcd">Playlist</spna> </i></h4>
                <h4 class="active"><span></span><i class=" bi active1 bi-music-note-beamed"><spna class="abcd">Last listening</spna></i></h4>
                <h4 class="active"><span></span><i class=" bi active1 bi-music-note-beamed"><spna class="abcd">Recommended</spna></i></h4>
            </div>
            <div class="menu_song">
                <li class="songItem">
                    <span>01</span>
        ...
        <div class="song_side">
            ...
            <div class="popular_song">
                ...
                <div class="pop_song">
                    ...
                    <li class="songItem">
                        ...
                        <h5>Ve Kamleya Mere Nadan Dil<br>
                            <div class="subtitle">Arjit Singh</div>
                        </h5>
                    </li>
                    <li class="songItem">
            ...
            <div class="popular_artists">
                ...
                <div class="item artists_bx">
                    <li><a href="arjit.html"><img src="img/1.jpg" alt=""></a></li>
