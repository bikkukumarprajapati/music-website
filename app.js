...
const songs = [
    ...
    {
        id: '4',
        songName: `Kareja Ho<br>
                        <div class="subtitle">ZB Rai</div>`,
        poster: "img/4.jpg"
    },
    {
        id: '5',
        songName: `Kareja Ho 2<br>
                        <div class="subtitle">ZB Rai</div>`,
        poster: "img/5.jpg"
    },
    {
    ...
    {
        id: '11',
        songName: `Ve Kamleya Mere Nadan Dil<br>
                            <div class="subtitle">Arjit Singh</div>`,
        poster: "img/11.jpg"
    },
    {
    ...
    {
        id: '13',
        songName: `ANIMAL: SATRANGA<br>
                            <div class="subtitle">Arjit Singh</div>`,
        poster: "img/13.jpg"
    },
    {
        id: '14',
        songName: `Masroof Hai dil kitna Tere Pyaar Mein<br>
    ...
    {
        id: '16',
        songName: `Badshah X Arjit Singh<br>
                            <div class="subtitle">Arjit Singh</div>`,
        poster: "img/16.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        ...
        // ind = "0" + index
        // poster_master_play.src = index < 10 ? `img/${ind}.jpg` : `img/${index}.jpg`
        music.play();
        // console.log(index); 
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
